...
class Alumno(Persona):#persona le hereda a alumno
    pass
...
(puedes dejar el código de los métodos en blanco con pass). Crea una clase llamada Automovil que herede estos métodos de Vehiculo.
'''
class Vehiculo:
    def acelerar(self):
        pass
